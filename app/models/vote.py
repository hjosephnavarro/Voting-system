...
class Vote:
    ...
    def create_table(self):
        ...
        CREATE TABLE IF NOT EXISTS vote (
            ...
            CONSTRAINT fk_vote_voter FOREIGN KEY (voter_id) REFERENCES voter(id) ON DELETE RESTRICT,
            CONSTRAINT fk_vote_candidate FOREIGN KEY (candidate_id) REFERENCES candidate(id) ON DELETE RESTRICT
        )
        """
